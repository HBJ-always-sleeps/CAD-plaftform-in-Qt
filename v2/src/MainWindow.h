...
private slots:
    ...
    void onMigrateSourceFileSelected(const QJsonObject &fileInfo);
    void onMigrateSourceFileCleared();
    void onMigrateTargetFileSelected(const QJsonObject &fileInfo);
    void onMigrateTargetFileCleared();
    void onTopviewFileSelected(const QJsonObject &fileInfo);
    void onTopviewFileCleared();
    void onTopviewSpineFileSelected(const QJsonObject &fileInfo);
    void onTopviewSpineFileCleared();
...
private:
    ...
    void createExcelMigrationParams(QGridLayout *layout);
    void createGeologyTopviewParams(QGridLayout *layout);
    ...
    QJsonObject m_migrateSourceFile;
    QJsonObject m_migrateTargetFile;
    QJsonObject m_topviewFile;
    QJsonObject m_topviewSpineFile;
    ...
    ParamCheckboxWidget *m_paramCombinedExtendOverexc;
    ...
    // excel_migrate
    ParamInputWidget *m_paramMigrationCoefficient;
    ParamInputWidget *m_paramMigrationOutputDir;

    // geology_topview
    ParamInputWidget *m_paramTopviewBackfillThickness;
    ParamInputWidget *m_paramTopviewOutputDir;

    // 文件选择组件
    FileRowWidget *m_fileRow;
    FileRowWidget *m_sourceFileRow;
    FileRowWidget *m_targetFileRow;
    FileRowWidget *m_migrateSourceFileRow;
    FileRowWidget *m_migrateTargetFileRow;
    FileRowWidget *m_topviewFileRow;
    FileRowWidget *m_topviewSpineFileRow;
};
